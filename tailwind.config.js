...
export default {
  ...
  theme: {
    extend: {
      colors: {
        /* 🌿 Paleta profesional - AutosDelCaribe */
        primary: {
          50:  '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
      ...
      /* 🌫️ Sombras profesionales mejoradas */
      boxShadow: {
        ...
        'card': '0 4px 20px rgba(0, 0, 0, 0.08), 0 2px 6px rgba(0, 0, 0, 0.04)',
        'card-hover': '0 12px 40px rgba(16, 185, 129, 0.3), 0 8px 16px rgba(16, 185, 129, 0.15)',
